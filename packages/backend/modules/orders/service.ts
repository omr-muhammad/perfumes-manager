...
// [QUERY] prepare order query filters
...
// [CREATE] get inventory rows used in order
...
// [CREATE] calculate alcohol average price
...
// [CREATE] Calcuate order bottle price => return ready data for db insertion
...
// [CREATE] calculate stock qts and amounts to be decreased
